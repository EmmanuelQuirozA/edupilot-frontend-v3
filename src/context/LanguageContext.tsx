...
const translations: TranslationMap = {
  es: {
    ...
    welcome: 'Bienvenido',
    studentsDashboardLabel: 'Panel de estudiantes',
    studentsDashboardDescription: 'Consulta tus pendientes financieros y mantén tu cuenta al día.',
    studentsTotalDue: 'Total a pagar',
    studentsLoading: 'Cargando...',
    studentsIncludesLateFees: 'Incluye {amount} por cargos de mora.',
    studentsViewMore: 'Ver más',
    studentsAvailableBalance: 'Saldo disponible',
    studentsBalanceHint: 'Úsalo para pagar en cafetería.',
    studentsPendingRequestsLabel: 'Solicitudes pendientes',
    studentsUpcomingPayments: 'Próximos pagos',
    studentsViewAll: 'Ver todo',
    studentsLoadingRequests: 'Cargando solicitudes...',
    studentsNoPendingRequests: 'No hay solicitudes pendientes.',
    studentsNoDate: 'Sin fecha',
    studentsOverdue: 'Vencido',
    studentsPending: 'Pendiente',
    studentsViewFullHistory: 'Ver historial completo',
    studentsRecentPaymentsLabel: 'Pagos recientes',
    studentsLatestMovements: 'Últimos movimientos',
    studentsLoadingRecentPayments: 'Cargando pagos recientes...',
    studentsNoRecentPayments: 'No hay pagos recientes.',
    profileTitle: 'Perfil',
    profileGreeting: 'Información de tu perfil',
    profileSubtitle: 'Consulta tus datos personales y actualiza tu contraseña.',
    profileLoading: 'Cargando datos...',
    profilePersonalSection: 'Datos personales',
    profileContactSection: 'Datos de contacto',
    profileSchoolSection: 'Datos de la escuela',
    profileAccessSection: 'Estado de la cuenta',
    profilePasswordSection: 'Cambiar contraseña',
    profilePasswordHelper: 'Usa una contraseña segura con al menos 8 caracteres.',
    profileFullName: 'Nombre completo',
    profileUsername: 'Usuario',
    profileRole: 'Rol',
    profileBirthDate: 'Fecha de nacimiento',
    profileEmail: 'Correo institucional',
    profilePersonalEmail: 'Correo personal',
    profilePhone: 'Teléfono',
    profileAddress: 'Dirección',
    profileCommercialName: 'Nombre comercial',
    profileBusinessName: 'Razón social',
    profileTaxId: 'RFC',
    profileSchoolStatus: 'Estatus de escuela',
    profileUserStatus: 'Estatus de usuario',
    profileRoleStatus: 'Estatus de rol',
    profileBalance: 'Saldo',
    profileOldPassword: 'Contraseña actual',
    ...
    footerText: 'EduPilot © 2026. Todos los derechos reservados.',
  ...
  en: {
    ...
    logout: 'Log out',
    welcome: 'Welcome',
    studentsDashboardLabel: 'Student dashboard',
    studentsDashboardDescription: 'Review your pending finances and keep your account up to date.',
    studentsTotalDue: 'Total due',
    studentsLoading: 'Loading...',
    studentsIncludesLateFees: 'Includes {amount} in late fees.',
    studentsViewMore: 'View more',
    studentsAvailableBalance: 'Available balance',
    studentsBalanceHint: 'Use it to pay at the cafeteria.',
    studentsPendingRequestsLabel: 'Pending requests',
    studentsUpcomingPayments: 'Upcoming payments',
    studentsViewAll: 'View all',
    studentsLoadingRequests: 'Loading requests...',
    studentsNoPendingRequests: 'No pending requests.',
    studentsNoDate: 'No date',
    studentsOverdue: 'Overdue',
    studentsPending: 'Pending',
    studentsViewFullHistory: 'View full history',
    studentsRecentPaymentsLabel: 'Recent payments',
    studentsLatestMovements: 'Latest transactions',
    studentsLoadingRecentPayments: 'Loading recent payments...',
    studentsNoRecentPayments: 'No recent payments.',
    profileTitle: 'Profile',
    profileGreeting: 'Your profile information',
    profileSubtitle: 'Review your personal details and update your password.',
    profileLoading: 'Loading details...',
    profilePersonalSection: 'Personal details',
    profileContactSection: 'Contact details',
    profileSchoolSection: 'School details',
    profileAccessSection: 'Account status',
    profilePasswordSection: 'Change password',
    profilePasswordHelper: 'Use a strong password with at least 8 characters.',
    profileFullName: 'Full name',
    profileUsername: 'Username',
    profileRole: 'Role',
    profileBirthDate: 'Birth date',
    profileEmail: 'Institutional email',
    profilePersonalEmail: 'Personal email',
    profilePhone: 'Phone',
    profileAddress: 'Address',
    profileCommercialName: 'Commercial name',
    profileBusinessName: 'Business name',
    profileTaxId: 'Tax ID',
    profileSchoolStatus: 'School status',
    profileUserStatus: 'User status',
    profileRoleStatus: 'Role status',
    ...
    footerText: 'EduPilot © 2026. All rights reserved.',

  ...
  const pageContent = (
    <div className="d-flex flex-column gap-4">
      <div className='card shadow-none'>
                  ...
                  return (
                    <Fragment key={role.role_id}>
                      <button
                        ...
                        onClick={() => setSelectedRoleId((current) => (current === role.role_id ? null : role.role_id))}
                      ...
                      {isSelected ? (
                        <div className="list-group-item border-top-0 bg-body-tertiary">
                          {permissionsSection}
                        </div>
                      ) : null}
                    </Fragment>
        ...
        {!selectedRoleId && selectedSchoolId ? (

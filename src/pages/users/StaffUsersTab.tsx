...
export function StaffUsersTab() {
  ...
  const { permissions, loading: permissionsLoading, error: permissionsError, loaded: permissionsLoaded } = useModulePermissions('users')
            ...
            <div className="d-flex align-items-center gap-2">
              {canCreate ? (
                ...
                >
                  ...
                  <span className="fw-semibold">{t('createUser')}</span>
                </button>
              ) : null}
            </div>
          </div>
